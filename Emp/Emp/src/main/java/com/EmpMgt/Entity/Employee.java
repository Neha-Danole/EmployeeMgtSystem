...
public class Employee {
	 ...
	 public Employee(Long id, @NotBlank(message = "Name is required") String name,
			...
			@NotBlank(message = "message Department is required") String department, @Positive Double salary) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
	...
	@Id
	 ...
	 @NotBlank(message = "message Department is required")
